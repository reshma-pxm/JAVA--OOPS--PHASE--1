...
import java.util.Scanner;
	...
	public class ApplicationFunctionality {
	    ...
	    public ApplicationFunctionality() {
	    ...
	    void Menu2() {
	        ...
	        try{
	            ...
	            switch (i){
	                case '4' : {
	                    System.out.print("To Add a file...Please Enter  File Name : ");
	                    String filename = sc.next().toLowerCase();
	                    addFile(filename);
	                    break;
	                }
	                case '5' : {
	                    System.out.print("To search for  a file...Please Enter a File Name : ");
	                ...
	                default : System.out.println("Please enter Option 4, 5, 6 or 7");
	            }
	            Menu2();
	        }
	        catch (Exception e){
	    ...
	    public static void main(String[] args) {
	        ...
	        ApplicationFunctionality  menu = new ApplicationFunctionality ();
	        menu.Menu1();
	    }
	}